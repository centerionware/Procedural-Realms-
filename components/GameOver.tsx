...
const GameOver: React.FC<GameOverProps> = ({ onRestart }) => {
  return (
    <div className="flex flex-col items-center justify-center text-center p-8 bg-gray-800 rounded-lg shadow-2xl animate-fade-in">
      <h1 className="text-6xl md:text-8xl font-bold text-red-500 mb-4 tracking-widest">
        GAME OVER
      </h1>
      <p className="text-lg text-gray-400 mb-8">Your adventure has come to an end.</p>
      <button
        onClick={onRestart}
